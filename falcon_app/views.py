...
def admin_dashboard(request):
    if 'Adm_id' in request.session:
        ...
        return render(request,'admin_dashboard.html',{'admin':admin,'flight':flight,'aircraft_count':aircraft_count,}) 
    else:
        return redirect('/')
...
def flight_check_in(request,id):
    ...
    return render(request,'user/flight_check-in.html',{'user':user,'flight':flight,'flight_pass':flight_pass})
